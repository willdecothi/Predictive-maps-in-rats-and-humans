...
dat_pd = cat(4, human_pd_sim_Q, human_pd_sim_MB, human_pd_sim_SR);
...
title('Human Trajectory Similarity')
ylabel('Distance to Agent Trajctory')
for i = 1:18
...
title('Human Trajectory Similarity: First 5 vs. Last 5 Trials')
