function [ action, p ] = SoftmaxLikeQ(Q, state_id, next_state_id, A_allowed)
...
% use greedy policy for value of future states
w = exp(invT * max(Q(poss_next,:),[],2)) / sum(exp(invT * max(Q(poss_next,:),[],2)));
